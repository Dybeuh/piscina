...
//TODO: Replicar la búsqueda por id-nombre de los monitores y piscinas visto en Socios. JList y demñas.
		...
		if (btnElmBaj.equals(arg0.getSource())) {
			if (jListSocios.getSelectedIndex() != -1) {
				...
				if (opcion == JOptionPane.YES_OPTION) {
					JOptionPane.showMessageDialog(this,
							"El socio " + elementoSeleccionado + " ha sido eliminado correctamente", "Confirmación",
							JOptionPane.INFORMATION_MESSAGE);
					if (usu == 0) {
						try {
//Indicar el fichero donde se guarda ya creado o se crea solo si no existe (src por defecto, sino poner ruta)        
